<html>
	...
	<br><br><br>
	<h2 align="center"> Les Dossiers Des Patients</h2>
	<div>
  ...
  <?php
		...
		foreach($values as $value){
			...
			<td >
			<button class="filled-btn"><a  href="ajouter_analyse.php?id=<?php echo $value['id']?>" class="btn">generer analyse</a></button></td>
			<td><?php echo $value['photo_analyse'] ?></td></tr>
			<tr>
			<th><strong>type Imagerie medicale:</strong></th>
			<td >
			<button class="filled-btn"><a href="ajouter_imagerie.php?id=<?php echo $value['id']?>" class="btn">generer imagerie_medicale</a></button></td>
			<td><?php echo $value['photo_imagerie_medicale'] ?></td></tr>
			<tr>
			<th><strong>les ordonnances:</strong></th>
			<td >
			<button class="filled-btn"><a href="ajouter_ordonances.php?id=<?php echo $value['id']?>" class="btn">generer ordonnances</a></button>
			...
			supprimer</a></button>
			<button class="filled-btn"><a href="ajouter_nouvelle_consultation.php?id=<?php echo $value['id']?>" class="btn">ajouter nouvelle consultation</a></button></td>
			</tr>
		<?php
		}
   ?>
