...
class PDF extends FPDF { 
	...
	function Header() { 
		...
		// Add logo to page 
		$this->Image('Ordonnance.png',170,8,33); 
		...
		// Header 
		$this->Cell(50,10,'ORDONNANCE',1,0,'C'); 
...
$pdf->SetFont('Times','',14); 
 ...
 $pdf->Ln(5);
    ...
    $pdf->MultiCell(0, 10,  $ordonnance, 0, 'L');
$pdf->Output(); 
 }
 ?>
 <br><br><br>
 <div id="petite_boite">
 <h2 align="center"> Generer ordonance</h2>
<form method="post" enctype="multipart/form-data" id="formulaire">
<br><br><br>
id patient:
<input type="text" name="id_patient"/><br>
ordonances:
<textarea name="ordonnance"/></textarea><br>
